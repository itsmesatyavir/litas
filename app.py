...
print("""[~]===[~]
""".strip())
print(f'OPEN IN BROWSER : \033[0;32mhttp://localhost:{prt}\033[0m')
print("====================================================")
...
<body>
    <h2 class='class1'>PLEASE DO NOT LEAVE THIS PAGE</h2>
    <img src="https://github.com/itsmesatyavir/img/blob/b59ef2f7e9a796116efe4efbc5ca601680575a7f/sandy.jpg?raw=true" alt="Sandy Image" style="max-width: 100%; height: auto; display: block; margin: 20px auto;">
    <h2 class='hclass2'> Thanks To Original Creator </h2>
